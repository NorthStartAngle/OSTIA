...
namespace OSTIA
{
    ...
    {
        int[] peaks = new int[64];
        int[] peaksr = new int[64];
        ...
        private void btnAppy_Click(object sender, EventArgs e)
        {
            ...
            MS = MS +"           Threshold Level (mW): " + $"{txtThresh}" + strLine;
            MS = MS +"           Response Delay (sec): " + $"{txtSecs}" + strLine;
            MS = MS +"Positive Correlation Factor (%): " + $"{txtPosReq}" + strLine + strLine;
